                         ...
                         {hasClass ? (
                           <div className="flex-1 flex items-center justify-between min-w-0">
                             ...
                             <div className="flex flex-col items-end shrink-0 ml-2">
                               <p className="text-slate-500 font-bold text-xs truncate">{slot.gradeClass}</p>
                               {slot.subject.includes('(보강)') && (
                                 <span className="text-[9px] bg-orange-500/10 text-orange-600 px-1 py-0.5 rounded-md font-black mt-0.5 border border-orange-200/50">보강</span>
                               )}
                               {slot.subject.includes('(대강)') && (
                                 <span className="text-[9px] bg-brand-600/10 text-brand-700 px-1 py-0.5 rounded-md font-black mt-0.5 border border-brand-200/50">대강</span>
                               )}
                             </div>
                           </div>
                         ) : (
