                  ...
                  allTimetables.map((t, index) => {
                    ...
                    return (
                      <tr key={t.id} className="hover:bg-blue-50/30">
                        ...
                        {/* After School Extensions (8, 9) - Optional: If we want to show them in the grid */}
                        {/* However, since 8, 9 are irregular and usually for specific teachers, 
                            showing them as extra columns or rows for ALL teachers might clutter. 
                            The requirement said "Table Bottom", but GlobalTimetable is a dense grid.
                            We'll stick to 1-7 in the dense grid and suggest users check After School page 
                            OR we can add 8, 9 to PERIODS if requested.
                            Given the user's "Dashboard" request included 8, 9, I will add 8, 9 to PERIODS array here too.
                        */}
                      </tr>
                    );
                  })
